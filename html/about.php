...
<div class="row">
	<div class="col-4"><img src="../Pictures/CMPhoto.png" class="img-fluid" alt="Photo of Caleb"></div>
...
<br>
<div class="row">
	<div class="col-4"><img src="../Pictures/CCPhoto.jpg" class="img-fluid" alt="Photo of Cameron"></div>
	<div class="col"><h3 style="color: white">Cameron is the lead application developer for the project Ardvark Math.</h3></div>
</div>
